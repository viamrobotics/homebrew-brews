...
# https://github.com/Homebrew/homebrew-core/blob/main/Formula/x/x264.rb with no
# --enable-shared passed to configure such that dynamic libraries are not generated.
class X264Static < Formula
  ...
  def install
    # No --enable-shared below (only --enable-static).
    args = %W[
      --prefix=#{prefix}
      --disable-lsmash
      --disable-swscale
